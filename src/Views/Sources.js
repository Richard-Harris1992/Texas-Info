  ...
  return (
    <div className="sourceContainer">
      ...
      <ol className="sourceList">
        ...
        <li>"VisitDallas: Dallas TX Attractions & Things To Do." VisitDallas, 2023, <a href="https://www.visitdallas.com/" className="sourceLink">https://www.visitdallas.com/</a>.</li>
